...
var gulp = require('gulp'),
    ...
    data = require('./src/content'), // Контент для передачи в шаблоны
...
gulp.task('sprite:build', function() {
    ...
    spriteData.img.pipe(gulp.dest(path.src.buildSprite)); // путь, куда сохраняем картинку
    spriteData.css.pipe(gulp.dest(path.src.cssSprite)); // путь, куда сохраняем стили
});
